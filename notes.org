...
process  FindMinimumPeptideProbability {
    ...
    """
    Mayu.pl -verbose -A $combined_search_results -C $fastadb_with_decoy -E DECOY_ -G $params.protFDR -P protFDR=${params.protFDR}:t -H 51 -I 2 -M $prefix
...
if (params.deepdia_min_detectability != null){
	...
	filter_peptide_by_detectability.py --peptide $deepdia_prefilt_peptide_list --detect $detect --min_detectability ${params.deepdia_min_detectability} --out ${deepdia_filtered_peptide_list}
	"""
    }
}
