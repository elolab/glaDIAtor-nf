...
See also its documentation https://github.com/lmsac/DeepDIA/raw/master/README.md
...
params.deepdia_ms2_entries = [
    ["2",
     ...
     "${params._deepdia_url}/data/peptides/Pan_human_charge2.peptide.csv"],
    ["3",
     "${params._deepdia_url}/data/charge3/epoch_034.hdf5",
     "${params._deepdia_url}/data/peptides/Pan_human_charge3.peptide.csv"]]
#+end_src
...
Channel
    ...
    .map( {
	    charge, model, peptides ->
	    tuple(charge, file(model), file(peptides))}
