...
process.container="file://../../gladiator/gladiator-images/what-gladiator-next.simg"
...
(defun gladiator-compile-test ()
  ...
  (let ((default-directory (concat (file-remote-p default-directory)
    ...
    (compile "module use /appl/user/modulefiles/ && module load nextflow && salloc nextflow -log `mktemp -u XXX.nextflow.log` run gladiator.nf")))
