...
https://openswath.org/_/downloads/en/latest/html/
*** OpenSwathWorkflow
...
process OpenSwathWorkflow {
    ...
    file openswath_transitions from openswath_transitions_ch
...
process pyprophet {
    ...
    "pyprophet --delim=tab --export.mayo "
