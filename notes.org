...
echo $RUNLOGDIR
sbatch --output=$RUNLOGDIR/slurm.log --err=$RUNLOGDIR/slurm.log --time=11:59:00 nextflow -log $RUNLOGDIR/.nextflow.log run gladiator.nf -with-trace $RUNLOGDIR/trace.txt -with-report $RUNLOGDIR/report.html -with-dag $RUNLOGDIR/graph.dot --fragment-mass-tolerance=0.025 --fastafiles=/data/epouta1/B22003_Elixir_DIA_Nextflow/datasets/pxd026600/REF_EColi_K12_UPS1_combined.fasta --diafiles='/data/epouta1/B22003_Elixir_DIA_Nextflow/datasets/pxd026600/DIA/MZML-pwiz/*.mzML' --ddafiles='/data/epouta1/B22003_Elixir_DIA_Nextflow/datasets/pxd026600/DDA/MZXML-pwiz/*.mzXML'
#+end_example
